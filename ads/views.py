...
class AdListView(ListView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        self.object_list = Ad.objects.all().order_by('-price')
        ...
        for i in page_obj:
            data.append({
                "id":i.id,
                "name":i.name,
                "author_id":i.author_id.id if i.author_id else None,
                "price":i.price,
                "description":i.description,
                "is_published":i.is_published,
                "image":json.dumps(str(i.image)) if i.image else None,
                "category_id":i.category_id.id if i.category_id else None
            })
